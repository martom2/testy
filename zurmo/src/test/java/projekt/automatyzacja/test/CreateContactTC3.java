...
public class CreateContactTC3 {
	...
	public CreateContactTC3(int row) {
		this.row = row;
	}
  ...
  public void setUp() {
    ...
    System.out.println("ROWS IN EXCEL: "+excel.getNumberOfRows());
    System.out.println("CELLS IN EXCEL: "+excel.getNumberOfCellsInARow(0));
  }
  ...
  public void createContact() {
	  ...
	  System.out.println("method create contact ROW: "+row);
  ...
  public void verifyCreatedContact() {
	  ...
	  System.out.println("Method verify contact ROW: "+row);
